...
const Credits = () => {
    return(
        <div id="creditDiv">
            ...
            <p id="creditElfText">Icon made by <a href="https://www.flaticon.com/authors/smashicons" target="_blank">Smashicons</a>  from <a href="http://www.flaticon.com" target="_blank">Flaticon</a>.</p>
        </div>
    )
}
